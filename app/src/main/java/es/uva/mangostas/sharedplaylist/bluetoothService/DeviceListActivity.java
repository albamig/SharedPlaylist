...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pairedDevices.size() > 0) {
            ...
            String noDevices = getString(R.string.notvinculateddispositives);
    ...
    private final AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Toast.makeText(getApplicationContext(), getString(R.string.iamconectedto) + address, Toast.LENGTH_LONG).show();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if(mNewDevicesAdapter.getCount() == 0) {
                    String noDevices = getString(R.string.notfound);
